...
*/
!function(e,t){"use strict";"function"==typeof define&&define.amd?define([],function(){return e.BotUI=t(e)}):e.BotUI=t(e)}("undefined"!=typeof window?window:this,function(e,t){"use strict";return function(t,n){function o(e,t,n,o){return"<a class='botui-message-content-link' target='"+(o?"blank":"")+"' href='"+n+"'>"+t+"</a>"}function i(e){return e.replace(v.image,"<img class='botui-message-content-image' src='$2' alt='$1' />").replace(v.icon,"<i class='botui-icon botui-message-content-icon fa fa-$1'></i>").replace(v.link,o)}function r(e,t){var n=document.createElement("script");n.type="text/javascript",n.src=e,t&&(n.onload=t),document.body.appendChild(n)}function s(e){y.action.addMessage&&h.message.human({delay:100,content:e}),y.action.show=!y.action.autoHide}function a(e){if(!e.loading&&!e.content)throw Error('BotUI:"content"is required in a non-loading message object.');e.type=e.type||"text",e.visible=!e.delay&&!e.loading;var t=y.messages.push(e)-1;return new Promise(function(n,o){setTimeout(function(){e.delay&&(e.visible=!0,e.loading&&(e.loading=!1)),n(t)},e.delay||0)})}function u(e){return"string"==typeof e&&(e={content:e}),e||{}}function c(e,t){for(var n in e)t.hasOwnProperty(n)||(t[n]=e[n])}function d(e){if(!e.action)throw Error('BotUI:"action"property is required.')}function l(e){return d(e),c({type:"text",cssClass:"",autoHide:!0,addMessage:!0},e),y.action.type=e.type,y.action.cssClass=e.cssClass,y.action.autoHide=e.autoHide,y.action.addMessage=e.addMessage,new Promise(function(t,n){p=t,setTimeout(function(){y.action.show=!0},e.delay||0)})}if(n=n||{},!t)throw Error("BotUI: Container id is required as first argument.");if(!document.getElementById(t))throw Error("BotUI: Element with id #"+t+" does not exist.");if(!e.Vue&&!n.vue)throw Error("BotUI: Vue is required but not found.");var f,m,p,g={debug:!1,fontawesome:!0},h={},v={icon:/!\(([^\)]+)\)/gim,image:/!\[(.*?)\]\((.*?)\)/gim,link:/\[([^\[]+)\]\(([^\)]+)\)(\^?)/gim};e.Vue=e.Vue||n.vue;for(var b in g)n.hasOwnProperty(b)&&(g[b]=n[b]);e.Promise||Promise||options.promise||r("https://cdn.jsdelivr.net/es6-promise/4.1.0/es6-promise.min.js");var w={template:"<div class=\"botui botui-container\" v-botui-container><div class=\"botui-messages-container\"><div v-for=\"msg in messages\" class=\"botui-message\" :class=\"msg.cssClass\" v-botui-scroll><transition name=\"slide-fade\"><div v-if=\"msg.visible\" :class=\"[{human: msg.human, \'botui-message-content\': true}, msg.type]\"><span v-if=\"msg.type == \'text\'\" v-text=\"msg.content\" v-botui-markdown></span> <iframe v-if=\"msg.type == \'embed\'\" :src=\"msg.content\" frameborder=\"0\" allowfullscreen></iframe></div></transition><div v-if=\"msg.loading\" class=\"botui-message-content loading\"><i class=\"dot\"></i><i class=\"dot\"></i><i class=\"dot\"></i></div></div></div><div class=\"botui-actions-container\"><transition name=\"slide-fade\"><div v-if=\"action.show\" v-botui-scroll><form v-if=\"action.type == \'text\'\" class=\"botui-actions-text\" @submit.prevent=\"handle_action_text()\" :class=\"action.cssClass\"><i v-if=\"action.text.icon\" class=\"botui-icon botui-action-text-icon fa\" :class=\"\'fa-\' + action.text.icon\"></i> <input type=\"text\" ref=\"input\" :type=\"action.text.sub_type\" v-model=\"action.text.value\" class=\"botui-actions-text-input\" :placeholder=\"action.text.placeholder\" :size=\"action.text.size\" :value=\"action.text.value\" :class=\"action.text.cssClass\" required v-focus/> <button type=\"submit\" :class=\"{\'botui-actions-buttons-button\': !!action.text.button, \'botui-actions-text-submit\': !action.text.button}\"><i v-if=\"action.text.button && action.text.button.icon\" class=\"botui-icon botui-action-button-icon fa\" :class=\"\'fa-\' + action.text.button.icon\"></i> <span>{{(action.text.button && action.text.button.label) || \'Go\'}}</span></button></form><div v-if=\"action.type == \'button\'\" class=\"botui-actions-buttons\" :class=\"action.cssClass\"> <button type=\"button\" :class=\"button.cssClass\" class=\"botui-actions-buttons-button\" v-for=\"button in action.button.buttons\" @click=\"handle_action_button(button)\" autofocus><i v-if=\"button.icon\" class=\"botui-icon botui-action-button-icon fa\" :class=\"\'fa-\' + button.icon\"></i> {{button.text}}</button></div></div></transition></div></div>",data:function(){return{action:{text:{size:30,placeholder:"Write here .."},button:{},show:!1,type:"text",autoHide:!0,addMessage:!0},messages:[]}},computed:{isMobile:function(){return e.innerWidth&&e.innerWidth<=768}},methods:{handle_action_button:function(e){s(e.text);var t={type:"button",text:e.text,value:e.value};for(var n in e)e.hasOwnProperty(n)&&"type"!==n&&"text"!==n&&"value"!==n&&(t[n]=e[n]);p(t)},handle_action_text:function(){this.action.text.value&&(s(this.action.text.value),p({type:"text",value:this.action.text.value}),this.action.text.value="")}}};e.Vue.directive("botui-markdown",function(e,t){"false"!=t.value&&(e.innerHTML=i(e.textContent))}),e.Vue.directive("botui-scroll",{inserted:function(e){m.scrollTop=m.scrollHeight}}),e.Vue.directive("focus",{inserted:function(e){e.focus()}}),e.Vue.directive("botui-container",{inserted:function(e){m=e}}),f=new e.Vue({components:{"bot-ui":w}}).$mount("#"+t);var y=f.$children[0];return h.message={add:function(e){return a(u(e))},bot:function(e){return e=u(e),a(e)},human:function(e){return e=u(e),e.human=!0,a(e)},get:function(e){return Promise.resolve(y.messages[e])},remove:function(e){return y.messages.splice(e,1),Promise.resolve()},update:function(e,t){var n=y.messages[e];return n.content=t.content,n.visible=!t.loading,n.loading=!!t.loading,Promise.resolve(t.content)},removeAll:function(){return y.messages.splice(0,y.messages.length),Promise.resolve()}},h.action={show:l,hide:function(){return y.action.show=!1,Promise.resolve()},text:function(e){return d(e),y.action.text=e.action,l(e)},button:function(e){return d(e),e.type="button",y.action.button.buttons=e.action,l(e)}},g.fontawesome&&r("https://use.fontawesome.com/ea731dcb6f.js"),g.debug&&(h._botApp=f),h}});function bot_ui_ini(){var botui=new BotUI("hello-javid");botui.message.add({delay:800,content:"こんにちは, 新来的小伙伴！"}).then(function(){botui.message.add({delay:1200,content:"这里是 Javid👀"}).then(function(){botui.message.add({delay:1200,content:"一个有点小帅气的男孩纸…😎"}).then(function(){botui.action.button({delay:1600,action:[{text:"然后呢? 😃",value:"sure"},{text:"呸！自恋 😒",value:"skip"}]}).then(function(a){"sure"==a.value&&sure();"skip"==a.value&&end()})})})});var sure=function(){botui.message.add({delay:600,content:"😘"}).then(function(){secondpart()})},end=function(){botui.message.add({delay:1500,content:"![...](https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.2.0/img/material/rp-dora1.jpg)"})},secondpart=function(){botui.message.add({delay:1500,content:"目前是某211的大学生👦"}).then(function(){botui.message.add({delay:1500,content:"平时非常喜欢听音乐💽…（一番好きだ!）"}).then(function(){botui.message.add({delay:1500,content:"“高性能电脑+优秀音响系统”-这对我来说就是人间天堂🎏"}).then(function(){botui.message.add({delay:2000,content:"研究方向是嵌入式相关，主攻Linux和C/C++，略懂Java和Python"}).then(function(){botui.message.add({delay:1800,content:"最近为了建站又开始折腾HTML/CSS/JavaScript/PHP了😅"}).then(function(){botui.message.add({delay:1800,content:"兴趣也是很广泛啦"}).then(function(){botui.action.button({delay:1500,action:[{text:"现在在做什么呢 🤔",value:""}]}).then(function(a){thirdpart()})})})})})})})},thirdpart=function(){botui.message.add({delay:1300,content:"学学日语和英语，刷刷Leetcode😷"}).then(function(){botui.message.add({delay:1300,content:"研究研究SLAM和自主导航算法"}).then(function(){botui.message.add({delay:1300,content:"闲了建建站，溜溜狗"}).then(function(){botui.message.add({delay:1500,content:"(欧冠没了好无聊呀~~~😣)"}).then(function(){botui.action.button({delay:1500,action:[{text:"未来有什么计划呢？😏",value:"sure2"},{text:"为什么要做网站呢？🤔",value:"sure3"}]}).then(function(a){"sure2"==a.value&&sure2();"sure3"==a.value&&sure3()})})})})})}var sure2=function(){botui.message.add({delay:1000,content:"未来计划去留学"}).then(function(){botui.message.add({delay:1200,content:"目前有几个我比较中意的机器人实验室非常想去😁"}).then(function(){botui.message.add({delay:1600,content:"现在也在努力提升自己，尤其是我的英语😂"}).then(function(){botui.message.add({delay:1500,content:"自己不懂的和要学的太多了"}).then(function(){botui.message.add({delay:1500,content:"各位以后还请多多指教啊😊"}).then(function(){botui.action.button({delay:1700,action:[{text:"为什么叫Javid呢？🤔",value:""}]}).then(function(){fourpart()})})})})})})},sure3=function(){botui.message.add({delay:1000,content:"这个原因是多方面的😂😂"}).then(function(){botui.message.add({delay:1200,content:"一方面是看了某前端大佬的视频，受到的启发；"}).then(function(){botui.message.add({delay:1700,content:"一方面是自己很早就想建一个博客网站来记录自己的成长😊；"}).then(function(){botui.message.add({delay:1800,content:"还有一方面是听到某学姐说他一个师兄，因为会做网站，"}).then(function(){botui.message.add({delay:1700,content:"教授帮忙给申了一笔高额奖学金还给找了个兼职😂"}).then(function(){botui.message.add({delay:1800,content:"其实最主要的还是自己从小就是一个对未知领域很感兴趣的人，"}).then(function(){botui.message.add({delay:1600,content:"尤其是对未知的技能🔧。"}).then(function(){botui.message.add({delay:1500,content:"毕竟技多不压身嘛，趁年轻多学点😁"}).then(function(){botui.action.button({delay:2000,action:[{text:"为什么叫Javid呢？🤔",value:""}]}).then(function(){fourpart()})})})})})})})})})},fourpart=function(){botui.message.add({delay:1500,content:"以我幼儿园水平英语就只能挤出这么个单词了..."}).then(function(){botui.message.add({delay:1200,content:"凑合看吧😂"}).then(function(){botui.action.button({delay:1600,action:[{text:"挺好听的呢😃",value:"sure"},{text:"是有点难听🙄",value:"skip"}]}).then(function(a){"sure"==a.value&&sure1();"skip"==a.value&&end1()})})})}var sure1=function(){botui.message.add({delay:600,content:"😘💕💓"}).then(function(){fifthpart()})},end1=function(){botui.message.add({delay:1500,content:"![...](https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.2.0/img/material/rp-dora1.jpg)"})},fifthpart=function(){botui.message.add({delay:1300,content:"啊哈哈哈哈哈哈hhhh，谢谢啦"}).then(function(){botui.message.add({delay:1500,content:"下面就请愉快的地欣赏我的博客吧！"}).then(function(){botui.message.add({delay:1500,content:"ゆっくりみましょう！😁"}).then(function(){botui.message.add({delay:1300,content:"![...](https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.2.0/img/material/rp-dora2.gif)"})})})})}}