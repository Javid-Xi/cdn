...
function imgError(ele, type) {
    switch (type) {
        case 1:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.0/img/others/Transparent.jpg';
            break;
        case 2:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.0/img/others/unknow.jpg';
            break;
        default:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.0/img/others/image-404.png';
    }
}
...
function loadBotui() {
    if ($('div').hasClass('popcontainer')) {
        if (mashiro_global.variables.has_bot_ui) {
            ...
            $.getScript('https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.0/js/botui/botui.js',
            //修改回复配置
            function() {
                bot_ui_ini();
