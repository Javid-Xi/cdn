...
function imgError(ele, type) {
    switch (type) {
        case 1:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.1.5/img/material/Transparent.jpg';
            break;
        case 2:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.1.5/img/material/unknow.jpg';
            break;
        default:
            ele.src = 'https://cdn.jsdelivr.net/gh/Javid-Xi/cdn@2.1.5/img/material/image-404.png';
    }
}
...
function add_copyright() {
    document.body.addEventListener("copy", function (e) {
        if (window.getSelection().toString().length > 80 && mashiro_option.clipboardCopyright) {
            setClipboardText(e);
        }
        addComment.createButterbar("复制成功啦！快去粘贴吧😝 <br>Copied to clipboard successfully!", 1000);
    });
...
var home = location.href,
    ...
    Siren = {
        ...
        NH: function () {
            //if(document.body.clientWidth > 860){ 修补移动端logo挡板无法显示
                var h1 = 0;
                $(window).scroll(function () {
...
$(function () {
    ...
    console.log("%c Javid %c", "background:#24272A; color:#ffffff", "", "https://javid.cn");
    console.log("%c Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/Javid-Xi");
});
